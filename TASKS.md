...
- [ ] ⬜ 1.18 Component SKUs — `planner.component_skus` expands Send-to-Cart into component lines; quote/CSV/PDF breakdown; surfaced in audit tool (S6) [Sprint 2] — **UNPARKED (A ruling 29 Jul); next build, NOT started** (A correction 19 Aug: no code commits since S5 `66a10fa`, so nothing is "in progress").
